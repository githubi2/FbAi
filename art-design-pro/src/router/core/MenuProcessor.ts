...
export class MenuProcessor {
  ...
  private readonly MENU_I18N_MAP: Record<string, string> = {
    ...
    AdAccountBmList: 'menus.adAccount.bmList',
    AdCampaign: 'menus.adCampaign.title',
    PageManage: 'menus.pageManage.title',
    PageManageList: 'menus.pageManage.list',
    PixelManage: 'menus.pixelManage.title',
    PixelManageList: 'menus.pixelManage.list',
  ...
  private readonly MENU_ICON_MAP: Record<string, string> = {
    ...
    AdAccountBmList: 'ri:building-2-line',
    AdCampaign: 'ri:megaphone-line',
    PageManage: 'ri:pages-line',
    PageManageList: 'ri:pages-line',
    PixelManage: 'ri:crosshair-2-line',
    PixelManageList: 'ri:crosshair-2-line',
